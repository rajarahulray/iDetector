...
frm_2 = tk.Frame(base);
frm_2.grid(row = 0, column = 0);

scoreboard=tk.Frame(root)
scoreboard.grid(row=0,column=0,columnspan=2)


frm_2_1 = tk.Frame(frm_2);
frm_2_1.grid(row = 0, column = 0, columnspan = 2);

frm_2_1_lab = tk.Label(frm_2_1, text = 'in frame_2_2 OF ROOT frm_2', bg = 'blue').grid(row = 0, column = 1, sticky = 'nsew')
